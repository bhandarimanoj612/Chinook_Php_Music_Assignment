<div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
    ...
    <div class="stats-card p-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-2xl font-bold text-black"><?= $trackCount ?></p>
            </div>
    ...
    <div class="card p-6">
        <div class="flex items-center justify-between">
            <div>
                <p class="text-sm font-medium text-secondary">Total Duration</p>
    ...
    <div class="card p-6">
        <div class="flex items-center justify-between">
            <div>
                <p class="text-sm font-medium text-secondary">Total Size</p>
    ...
    <div class="card p-6">
        <div class="flex items-center justify-between">
            <div>
                <p class="text-sm font-medium text-secondary">Avg Price</p>
                <p class="text-2xl font-bold text-white">$<?= number_format($avgPrice, 2) ?></p>
            </div>
            <svg class="w-8 h-8 text-secondary" fill="currentColor" viewBox="0 0 20 20">
                <path

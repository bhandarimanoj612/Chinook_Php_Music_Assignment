<!-- This file displays success messages for Album creation and deletion actions. -->
<?php if (isset($_GET['created']) && !empty($_GET['created'])): ?>
    <!-- Success message for Album creation -->
    <div id="success-created-message" class="mb-6 bg-green-900/20 border border-green-500/30 rounded-lg p-4">

        <!-- This section displays a success message when an Album is created -->
        <div class="flex items-center">
         ...
         7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd" />
            ...
            <p class="text-green-300">
                <strong>Success!</strong> Album "<?= htmlspecialchars($_GET['created']) ?>" was created
                successfully.
            </p>
...
<!-- This section displays a success message when an Album is deleted -->
<?php if (isset($_GET['deleted']) && !empty($_GET['deleted'])): ?>
    <!-- Success message for Album deletion -->
    <div id="success-message" class="mb-6 bg-green-900/20 border border-green-500/30 rounded-lg p-4">
        <div class="flex items-center">
            ...
            <p class="text-green-300">
                <strong>Success!</strong> Album "<?= htmlspecialchars($_GET['deleted']) ?>" has been
